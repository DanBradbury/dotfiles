...
"let s:N1   = [ '#000000' , '#dfff00' , 0  , 0 ]
let s:N1   = [ '#000000' , '#ffcc00' , 0  , 0 ]
let s:N2   = [ '#ffffff' , '#004f27' , 255 , 238 ]
let s:N3   = [ '#009c4d' , '#202020' , 85  , 234 ]
let g:airline#themes#goducks#palette.normal = airline#themes#generate_color_map(s:N1, s:N2, s:N3)

" Here we define overrides for when the buffer is modified.  This will be
" applied after g:airline#themes#goducks#palette.normal, hence why only certain keys are
" declared.
...
let s:I1 = [ '#004f27' , '#ffffff' , 17  , 45  ]
let s:I2 = [ '#ffffff' , '#005fff' , 255 , 27  ]
let s:I3 = [ '#ffffff' , '#004f27' , 15  , 17  ]
let s:I4 = [ '#000000' , '#ffcc00' , 15  , 17  ]
...
let g:airline#themes#goducks#palette.insert_modified = {
      \ 'airline_c': [ '#004f27' , '#000000' , 255     , 53      , ''     ] ,
      \ }
...
let g:airline#themes#goducks#palette.replace.airline_a = [ s:I2[0]   , '#af0000' , s:I2[2] , 124     , ''     ]
...
let s:V1 = [ '#ffffff' , '#004f27' , 232 , 214 ]
let s:V2 = [ '#000000' , '#ffcc00' , 15  , 17  ]
let s:V3 = [ '#ffffff' , '#004f27' , 15  , 17  ]
...
let g:airline#themes#goducks#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(
      \ [ '#d7d7ff' , '#19603c' , 189 , 55  , ''     ],
      \ [ '#ffffff' , '#327252' , 231 , 98  , ''     ],
      \ [ '#000000' , '#ffcc00' , 55  , 231 , 'bold' ])
